...
public final class SqliteShopNotificationRepository implements ShopNotificationRepository {

    private final DataSource dataSource;

    public SqliteShopNotificationRepository(DataSource dataSource) {
